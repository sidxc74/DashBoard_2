...
function Payout() {
  const payoutData = [
    { Type: 'Electrician', value: (3000 / 11000).toFixed(1) * 100 },
    { Type: 'Plumber', value: (1750 / 11000).toFixed(1) * 100 },
    { Type: 'Gardener', value: (2250 / 11000).toFixed(1) * 100 },
    { Type: 'Cook', value: (4000 / 11000).toFixed(1) * 100 },
  ];
...
const renderCustomizedLabel = ({ cx, cy, midAngle, innerRadius, outerRadius, percent, index }) => {
  ...
  return (
    <div className='w-full flex justify-center items-center bg-[#121212] rounded-3xl p-6 my-10'>
      ...
      <div>
      <div className='text-2xl font-bold text-center'>Total Payout</div>
      <div className='text-3xl text-[#cf6679] font-bold text-center'>₹11000</div>
